...
\scomment{Missing the results. Also discussion/conclusion.}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{{chapter5/figures/fig5.3.1}.png}
